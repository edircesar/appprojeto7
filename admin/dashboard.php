...
<head>
    ...
    <style>
        ...
        .card { background: white; padding: 20px; border-radius: var(--border-radius); box-shadow: var(--shadow); }
        ...
        .icon-option input:not(:checked) + span:hover { background: #eee; border-color: #bbb; }
    </style>
</head>
<body style="padding-top: 0; background: #f0f2f5;">

    <div class="admin-header">
        <h2>Projeto7 Hub - Painel Administrativo</h2>
